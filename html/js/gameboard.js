		...
		for (var i = 0; i < yCellsNumber; i++)
		{
			for (var j = 0; j < xCellsNumber; j++)
			{
				switch (this.cells[i][j])
				{
					...
					*/
					case 1:
						this.ctx.drawImage(this.destructible, 
                                                        j * 40, 
                                                        i * 40, 
                                                        this.indestructible.width, 
                                                        this.indestructible.height);
						break;
					case 2:
						this.ctx.drawImage(this.indestructible, 
                                                        j * 40, 
                                                        i * 40, 
                                                        this.indestructible.width, 
                                                        this.indestructible.height);
